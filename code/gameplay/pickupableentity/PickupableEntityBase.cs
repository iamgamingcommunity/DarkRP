...
public class PickupableEntityBase : Component
{
	...
	[Property, Feature("Equipment Damage/Ammo Info"), Group("Swep Ammo Info"), Title("Explosive Damage Delay"), Description("The Delay when the explosive is not dealing damage anymore."), ShowIf ( nameof( EquipmentExplosiveDamage ), true)] public float EquipmentExplosiveDelay { get; set; }	
	[Property, Feature("Equipment Damage/Ammo Info"), Group("Swep Ammo Info"), ShowIf ( nameof( EquipmentUsingDefaultWeaponSystem ), true), Title("Explosive Prefab")] public PrefabFile EquipmentExplosivePrefab { get; set; }
	...
	[Property, Feature("Equipment Damage/Ammo Info"), Title("Amount of Projectiles Fired"), Group("Equipment Damage/Ammo Info")] public int EquipmentAmountOfRoundsFired { get; set; }
	...
	public delegate void ActionGraphSwepDefaultDRPDryFire(GameObject PlayerControllerRef);
	[Property, Feature("Action Graphs"), Group("Default DarkRP Ballistic System"), ShowIf ( nameof( EquipmentUsingDefaultWeaponSystem ), true), Title("Default DryFire")] public ActionGraphSwepDefaultDRPDryFire GraphSwepDefaultDRPDryFire { get; set; }
...
public struct PlayerKeyAction
{
	...
	public void SwepDefaultDRPDamageSystem (GameObject PlayerControllerRef, GameObject HitGameObjectRef, Vector3 TempNormal, Vector3 TempEndPos, float TempDistance, int BoneIndex, float TempDamage)
	{
		GraphSwepDefaultDRPDamageSystem?.Invoke(PlayerControllerRef, HitGameObjectRef, TempNormal, TempEndPos, TempDistance, BoneIndex, TempDamage);
	}
	...
	public void SwepDefaultDRPDryFire (GameObject PlayerControllerRef)
	{
		GraphSwepDefaultDRPDryFire?.Invoke(PlayerControllerRef);
	}
