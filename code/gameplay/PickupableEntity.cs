...
public class PickupableEntity : GameResource
{
	...
	[Property, Feature("Equipment Base Info"), Group("Base Info"), Description("This places the weapon the in the catagory you set in one of the F4 menus.")] public string F4BuyMenuCategory{ get; set; }
